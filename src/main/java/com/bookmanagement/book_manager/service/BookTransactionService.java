...
public class BookTransactionService {
    ...
    @Transactional
public Map<Long, String> borrowBooks(Long userId, List<Long> bookIds) {
    ...
    for (Long bookId : bookIds) {
        ...
        List<BookTransaction> activeTransactions = 
                transactionRepository.isBookBorrowed(book.getId());
    ...
    @Transactional
    public Map<Long, String> returnBooks(Long userId, List<Long> bookIds) {
